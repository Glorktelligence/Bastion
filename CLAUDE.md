...
### Protocol First
- ALL message type changes start in `@bastion/protocol` package (85 message types, 48 error codes).
...
```
packages/
├── protocol/           → @bastion/protocol (85 message types, schemas, constants — FOUNDATION)
