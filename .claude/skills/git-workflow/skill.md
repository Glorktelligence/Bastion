...
2. **Run full test suite** (mandatory — all 13 files must pass):
...
Expected: 2,879+ tests, 0 failures.
...
- [ ] **Test count badge** — if tests were added or removed (currently 2,879)
...
□ Full test suite passes (all 13 files, 2,879+ tests)
